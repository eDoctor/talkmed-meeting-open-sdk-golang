...
func NewRegisterRequest() *RegisterRequest {
	...
	r.bRequest.ApiRequestUri = constants.UserRegisterRequestUri
 ...
 *
 */
func (r *RegisterRequest) SetApiVersion(apiVersion string) *RegisterRequest {
	r.bRequest.ApiVersion = apiVersion
	return r
}

func (r *RegisterRequest) Request(client *meeting.MeetClient) request.ApiResponse {
